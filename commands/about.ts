...
module.exports = {
    ...
    execute(msg, args) {
        ...
        .setColor('#02f2ce')
        .setDescription(`\**ICOC Teens\** is an all-purpose discord bot for the discord server "ICOC Teens". It's main purpose is moderation. But, it also includes 34+ informational and fun commands!`)

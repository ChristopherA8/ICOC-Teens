module.exports = {
    ...
    execute(msg) {
        ...
        var url = `https://opentdb.com/api.php?amount=1&category=15&difficulty=easy&type=boolean&encode=url3986&token=4dfaa8e46fe332a7cb41f3d700ffead9f7f59512522a24c04d026b24ac41150c`;
